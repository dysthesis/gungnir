  ...
  with config;
    ...
    */
    ''
      ...
      static int borderpx = ${toString borderpx};
      ...
      static float cwscale = ${toString fontScale.width};
      static float chscale = ${toString fontScale.height};
       ...
       *
       * Adapted from the lackluster.nvim kitty theme:
       * https://github.com/slugbyte/lackluster.nvim/blob/main/extra/kitty/lackluster.conf
       */
      static const char *colorname[] = {

          /* 8 normal colors */
          "${colours.normal.black}", "${colours.normal.red}", "${colours.normal.green}", "${colours.normal.orange}", "${colours.normal.blue}", "${colours.normal.magenta}", "${colours.normal.cyan}", "${colours.normal.white}",

          /* 8 bright colors */
          "${colours.bright.black}", "${colours.bright.red}", "${colours.bright.green}", "${colours.bright.orange}", "${colours.bright.blue}", "${colours.bright.magenta}", "${colours.bright.cyan}", "${colours.bright.white}",

          [256] = "${colours.foreground}", /* default foreground colour */
          [257] = "${colours.background}", /* default background colour */
          [258] = "${colours.highlight}", /*575268*/
      };
